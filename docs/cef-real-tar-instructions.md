...
HEAD tests in this session on patterns (131/132/120) returned 200 Connection established — tar is available at the CDN. Full download may be slow/large; do on workstation with good net.
